  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <Card className="p-8 mb-6 border-gray-200">
        <h3 className="text-gray-900 mb-6 pb-4 border-b border-gray-200">
          Transaction Details
        </h3>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Button onClick={onBackToInvoices} variant="outline" className="flex-1">
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-blue-900" style={{ fontSize: "14px" }}>
          ...
          questions about this transaction, please contact our support team with
          your Payment ID: <strong>{payment.id}</strong>
        </p>
      </div>
    </div>
  );
